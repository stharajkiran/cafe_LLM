...
class RecommendationAgent():
    ...
    def get_popular_recommendation(self,product_categories=None,top_k=5):
        ...
        if product_categories is not None:
            # Filter the recommendation with the given product categories
            recommendations_df = self.popular_recommendations[self.popular_recommendations['product_category'].isin(product_categories)]
        # Sort with transaction counts where the higher count are more recommended
    ...
    def get_response(self,messages):
        """_returns the recommendations as dictionary.
      
        Args:
            messages (list): list of dictionaries
            Eg:
        ...
        recommendations = [] # Stores the recommendations
