...
class GuardAgent():
    ...
    def get_response(self, messages):
        ...
        """_returns the validity of the user request.
            ...
            Returns:
                Dict: 
             {
                'chain of thought': 'The user is asking about the menu items and their prices, which is relevant to the coffee shop.', 
                'decision': 'allowed', 
                'message': ''
             }
